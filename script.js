...
function myFunction() {
    ...
    if(keyboardInput.value === "600") {window.open("https://ironhacklisboncampus.slack.com/archives/C04B4UBJ1UP", '_blank'); keyboardInput.value = keyboardInput.value.slice(0,-4);}
